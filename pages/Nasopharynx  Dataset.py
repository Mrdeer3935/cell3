        ...
        if option == "SCP1289":
            st.markdown("""<div style="background-color: #4169E1; width: 100%; padding: 20px; border-radius: 20px;">
                                              ...
                                              <ul style="list-style: none; text-align: left;">
                                                ...
                                                <li><strong style="color: black; font-weight: bold; font-size: 20px;">Accession processed data: </strong><a href="https://singlecell.broadinstitute.org/single_cell/study/SCP1289/impaired-local-intrinsic-immunity-to-sars-cov-2-infection-in-severe-covid-19"; style="color: black; font-weight: bold; font-size: 20px">SCP1289</a></li>
                                                </ul>
